...
# request.
create_authn_request = (issuer, assert_endpoint, destination, force_authn, is_passive, context, nameid_format) ->
  if context?
  ...
  class ServiceProvider
    ...
    constructor: (options) ->
      ...
      @shared_options = _(options).pick(
        "force_authn", "assert_endpoint", "auth_context", "nameid_format", "sign_get_request", "allow_unencrypted_assertion", "audience", "notbefore_skew")
