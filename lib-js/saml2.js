...
create_authn_request = function(issuer, assert_endpoint, destination, force_authn, is_passive, context, nameid_format) {
...
module.exports.ServiceProvider = ServiceProvider = (function() {
  function ServiceProvider(options) {
    ...
    this.shared_options = _(options).pick("force_authn", "assert_endpoint", "auth_context", "nameid_format", "sign_get_request", "allow_unencrypted_assertion", "audience", "notbefore_skew");
  }
